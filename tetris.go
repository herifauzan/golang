...
//   Version: 1.0.6 06/08/2013 BeiJing China [Updated 01/25/2015]        //
//                                                                       //
//   Algorithm:                                                          //
//                                                                       //
//   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   //
...
func get_args() bool {
     ...
     if args_len == 2 {
        ...
        case "-h", "--help":
             ...
             return true
        case "-v", "--version":
             fmt.Printf("Tetris Game  Version 1.0.6 [Updated 01/25/2015]\n")
             return true
        default:
             runlevel, _ = strconv.Atoi(os.Args[1])
             return false
...
func (this *board) notify() {
      ...
      fmt.Printf(esc+"[38;5;106;1m"+esc+"["+strconv.Itoa(toph+19)+";"+strconv.Itoa(dist)+"HTetris Game  Version 1.0.6\n")
      str12 := esc+"["+strconv.Itoa(toph+20)+";"+strconv.Itoa(dist)+"HYongYe <complex.invoke@gmail.com>"+esc+"["
      str13 := strconv.Itoa(toph+21)+";"+strconv.Itoa(dist)+"H06/08/2013 BeiJing China [Updated 01/25/2015]"
...
func (this *board) matrix() {
      ...
      fmt.Printf(esc+"["+strconv.Itoa(toph+23)+";"+strconv.Itoa(dist)+"H"+colbon+"Algorithm:"+two+str2+one+str5+str5+str2+str4+"\n")
